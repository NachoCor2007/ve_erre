Shader "Neko Legends/Cel Shader/Metals V2"
{
    Properties
    {
        [Header(Main)]
    ...
    SubShader
    {
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            float4 Color_6663d48c6e414f5683c78df896cc99aa = IsGammaSpace() ? LinearToSRGB(float4(0, 0, 0, 0)) : float4(0, 0, 0, 0);
            float3 _Multiply_fbfb33fa03654418b7ca6b75100ab7db_Out_2_Vector3;
            Unity_Multiply_float3_float3(_Add_e9066678904e4fd590e41227b2822728_Out_2_Vector3, (Color_6663d48c6e414f5683c78df896cc99aa.xyz), _Multiply_fbfb33fa03654418b7ca6b75100ab7db_Out_2_Vector3);
            ...
            surface.Emission = _Multiply_fbfb33fa03654418b7ca6b75100ab7db_Out_2_Vector3;
